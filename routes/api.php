...
Route::middleware('api')->group(function () {
    ...
    Route::middleware('api')->group(function () {
        ...
        #Route::get('/categories/{idcat}', [CategorieController::class, 'showArticleByCAT']);
        Route::get('/categories/{categoryId}/articles', [CategorieController::class, 'getArticlesByCategory']);
